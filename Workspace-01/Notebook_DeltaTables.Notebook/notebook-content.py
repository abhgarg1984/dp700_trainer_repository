...
df.write.format("delta").saveAsTable("external_products", path="abfss://DAY01_WS@onelake.dfs.fabric.microsoft.com/lakehouse.Lakehouse/Files/external_products")
...
# MAGIC %%sql
# MAGIC 
# MAGIC select * from products VERSION AS of 0 limit 10;
...
# MAGIC %%sql
# MAGIC select * from products VERSION AS of 1 limit 10;
...
# MAGIC %%sql
# MAGIC -- Create a temporary view
# MAGIC CREATE OR REPLACE VIEW products_view
# MAGIC AS
# MAGIC     SELECT Category, COUNT(*) AS NumProducts, MIN(ListPrice) AS MinPrice, MAX(ListPrice) AS MaxPrice, AVG(ListPrice) AS AvgPrice
# MAGIC     FROM managed_products
# MAGIC     GROUP BY Category;
...
# MAGIC %%sql
# MAGIC 
# MAGIC select * from csv.`abfss://DAY01_WS@onelake.dfs.fabric.microsoft.com/lakehouse.Lakehouse/Files/products/products.csv`
...
# MAGIC %%sql
# MAGIC create table test_products using delta
# MAGIC SELECT * FROM 
# MAGIC read_files( 'abfss://DAY01_WS@onelake.dfs.fabric.microsoft.com/lakehouse.Lakehouse/Files/products'
# MAGIC ,format=> 'CSV'
# MAGIC );
